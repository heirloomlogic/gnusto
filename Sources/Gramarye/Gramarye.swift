...
struct Gramarye: Game, GameMain {
    ...
    /// the gallery would leave no way back through (#614). The study half keeps
    /// the slam in the room its copy is written for.
    ///
