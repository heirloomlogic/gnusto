...
@resultBuilder
public enum LocationBuilder {
    public static func buildExpression(_ trait: LocationTrait) -> [LocationTrait] {
        [trait]
    }

    public static func buildBlock(_ traits: [LocationTrait]...) -> [LocationTrait] {
        traits.flatMap(\.self)
    }

    public static func buildOptional(_ traits: [LocationTrait]?) -> [LocationTrait] {
        traits ?? []
    }

    public static func buildEither(first traits: [LocationTrait]) -> [LocationTrait] {
        traits
    }

    public static func buildEither(second traits: [LocationTrait]) -> [LocationTrait] {
        traits
    }
}
...
public enum ItemBuilder {
    public static func buildExpression(_ trait: ItemTrait) -> [ItemTrait] {
        [trait]
    }

    public static func buildBlock(_ traits: [ItemTrait]...) -> [ItemTrait] {
        traits.flatMap(\.self)
    }

    public static func buildOptional(_ traits: [ItemTrait]?) -> [ItemTrait] {
        traits ?? []
    }

    public static func buildEither(first traits: [ItemTrait]) -> [ItemTrait] {
        traits
    }

    public static func buildEither(second traits: [ItemTrait]) -> [ItemTrait] {
        traits
    }
}
