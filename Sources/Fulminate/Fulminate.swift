...
struct Fulminate: Game, GameMain {
    ...
    let parlourFurniture = Item.scenery(
        "furniture",
    ...
    let cellarStepsBelow = Item.scenery(
        "cellar steps",
    ...
    let carriageHouseOutside = Item.scenery(
    ...
    let labLamp = Item.scenery("lamp", adjectives: "tin", "shaded", "yard", synonyms: "light", "bulb")

    let toolRack = Item.scenery(
        "tool rack", adjectives: "tool", "iron", "wall",
        synonyms: "rack", "tools", "tool", "nail", "nails", "board", "outline", "pencil")

    let cot = Item.scenery(
